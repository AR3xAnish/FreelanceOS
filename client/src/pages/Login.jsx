    ...
    <div className="max-w-md mx-auto py-8">
      <div className="bg-[#111111] border border-[#ffffff08] border-t-2 border-t-[#10B981] rounded-lg p-8 space-y-6 shadow-xl">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-gray-500 font-normal">Sign in to manage your workspace</p>
        </div>
        ...
        <div className="text-center text-xs text-gray-500 pt-2 border-t border-[#ffffff08]">
          ...
          <Link to="/register" className="text-[#10B981] hover:text-[#059669] font-semibold transition-colors duration-200">
            Sign up
          </Link>
        </div>
      </div>
